package it.paolopasianot.cosmobile.core.designsystem.component
...
/**
 * Cosmobile toggle button with icon and checked icon content slots. Wraps Material 3
 * [IconButton].
 *
    ...
    colors = IconButtonDefaults.iconToggleButtonColors(
      ...
      disabledContainerColor = if (checked) {
        MaterialTheme.colorScheme.onBackground.copy(
          alpha = CosmobileIconButtonDefaults.DISABLED_ICON_BUTTON_CONTAINER_ALPHA,
        )
      } else {
        Color.Transparent
      },
...
fun IconButtonPreview() {
  AppTheme {
    CosmobileIconToggleButton(
      checked = true,
      onCheckedChange = { },
      icon = {
        Icon(
          imageVector = CosmobileIcons.BookmarkBorder,
          contentDescription = null,
        )
      },
      checkedIcon = {
        Icon(
          imageVector = CosmobileIcons.Bookmark,
          contentDescription = null,
        )
      },
    )
...
/**
 * Cosmobile icon button default values.
 */
object CosmobileIconButtonDefaults {
  // TODO: File bug
